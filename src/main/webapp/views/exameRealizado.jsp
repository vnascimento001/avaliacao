...
<body>
	...
	<div class="d-flex justify-content-end">
		<a
			href="<s:url action='adicionarExameRealizado' namespace='/'></s:url>"
			class="btn btn-primary mr-2">Realizar exame</a> <a
			href="<s:url action='relatorio' namespace='/'></s:url>"
	...
	<div
		...
		<div class="card" style="width: 60rem;">
			<div class="card-header text-center">
				...
				<form method="GET"
					action="<s:url action='listarExamesRealizados' namespace='/'></s:url>">
					<div class="form-row">
						...
						<div class="col-md-4">
							<select class="form-control" name="cdFuncionario">
								...
								<s:iterator value="funcionarios">
									<option value="<s:property value="cdFuncionario"/>"><s:property
											value="nmFuncionario" /></option>
								</s:iterator>
							</select>
						</div>
						<div class="col-md-4">
							<select class="form-control" name="cdExame">
								...
								<s:iterator value="exames">
									<option value="<s:property value="cdExame"/>"><s:property
											value="nmExame" /></option>
								</s:iterator>
							</select>
						</div>
						<div class="col-md-4">
								...
								<tr>
									...
									<td><a
										...
										class="btn btn-primary mr-2">Editar</a> <s:url id="deleteUrl"
											action="deletarExameRealizado" namespace="/">
